...
public class GoogleDriveApiDataRepository {
    ...
    private final String FILE_MIME_TYPE = "image/*";
    ...
    public Task<Void> readFile(@NonNull final java.io.File file, @NonNull final String fileId) {
    ...
    private Task<Void> writeFile(@NonNull final java.io.File file, @NonNull final String fileId, @NonNull final String fileName
    ) {
        return Tasks.call(mExecutor, () -> {
    ...
    public File getMetaData(@NonNull final String fileName) {
        return new File()
